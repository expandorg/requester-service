# Contributing to expandorg/requester-service
...
### Report bugs using Github's [issues](https://github.com/expandorg/requester-service/issues)
...
Enhancement suggestions are tracked as GitHub [issues](https://github.com/expandorg/requester-service/issues). Create an issue on this repository and provide the following information:
...
`go get -u github.com/expandorg/requester-service`

or create a directory `$GOPATH/src/github/expandorg` and execute: git clone git@github.com:expandorg/requester-service.git 
