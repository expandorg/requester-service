...
create a directory `$GOPATH/src/github/expandorg` and execute: git clone git@github.com:expandorg/requester-service.git 
...
If you're interested in contributing to the requester service:

 * Start by reading the [Contributing guide](CONTRIBUTING.md).

## License

Requester service is licensed under the [MPL-2](license) license
